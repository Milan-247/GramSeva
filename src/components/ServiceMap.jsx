...
import { Search, MapPin, Phone, Clock, Siren } from "lucide-react";
  ...
  useEffect(() => {
    ...
    const invalidate = () => {
      try {
        ...
        // ignore if map container unmounted
      }
    };
...
export default function ServiceMap({
  ...
  return (
    <div className="real-map-shell flex-1 flex flex-col min-h-0 h-full gap-2.5 p-2.5 sm:p-4 bg-stone-50 pb-20 sm:pb-24">
      {/* Search & Quick Toggles */}
      <div className="bg-white border border-stone-200 rounded-2xl p-3 sm:p-3.5 shadow-2xs space-y-2.5 shrink-0">
        {/* Search & Quick Toggles */}
      ...
      <div className="real-map-panel relative rounded-2xl overflow-hidden border border-stone-300 shadow-xs flex-1 min-h-[360px] sm:min-h-[420px] h-full w-full">
        <MapContainer
          center={center}
          zoom={12}
          scrollWheelZoom
          ...
          fadeAnimation
          markerZoomAnimation
          className="real-map-canvas w-full h-full min-h-[360px] sm:min-h-[420px]"
