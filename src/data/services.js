...
import { buildPanchayatServices, REPRESENTATIVE_NAMES, KERALA_TEMPLATES, KARNATAKA_TEMPLATES, TAMILNADU_TEMPLATES, ANDHRAPRADESH_TEMPLATES } from "./stateServiceGenerators.js";
...
const BASE_SERVICES = [
  ...
  },
  {
    ...
    isEmergency: false,
    districtName: "Kozhikode",
    localityName: "Azhiyur",
    translations: {
      ml: {
        title: "\u0D05\u0D34\u0D3F\u0D2F\u0D42\u0D7C \u0D17\u0D4D\u0D30\u0D3E\u0D2E\u0D2A\u0D1E\u0D4D\u0D1A\u0D3E\u0D2F\u0D24\u0D4D\u0D24\u0D4D \u0D06\u0D38\u0D4D\u0D25\u0D3E\u0D28 \u0D15\u0D3E\u0D30\u0D4D\u0D2F\u0D3E\u0D32\u0D2F\u0D02",
        description: "\u0D05\u0D34\u0D3F\u0D2F\u0D42\u0D7C \u0D17\u0D4D\u0D30\u0D3E\u0D2E\u0D2A\u0D1E\u0D4D\u0D1A\u0D3E\u0D2F\u0D24\u0D4D\u0D24\u0D4D \u0D24\u0D26\u0D4D\u0D26\u0D47\u0D36 \u0D2D\u0D30\u0D23\u0D15\u0D47\u0D28\u0D4D\u0D26\u0D4D\u0D30\u0D02 (\u0D05\u0D34\u0D3F\u0D2F\u0D42\u0D7C, \u0D1A\u0D4B\u0D2E\u0D4D\u0D2A\u0D3E\u0D32, \u0D2E\u0D41\u0D15\u0D4D\u0D15\u0D3E\u0D33\u0D3F \u0D2E\u0D47\u0D16\u0D32\u0D15\u0D7E). \u0D1C\u0D28\u0D28-\u0D2E\u0D30\u0D23 \u0D30\u0D1C\u0D3F\u0D38\u0D4D\u0D1F\u0D4D\u0D30\u0D47\u0D37\u0D7B, \u0D2A\u0D46\u0D7B\u0D37\u0D7B \u0D35\u0D3F\u0D35\u0D30\u0D19\u0D4D\u0D19\u0D7E, \u0D24\u0D40\u0D30\u0D26\u0D47\u0D36 \u0D35\u0D3F\u0D15\u0D38\u0D28 \u0D2F\u0D4B\u0D1C\u0D28.",
        category: "\u0D24\u0D26\u0D4D\u0D26\u0D47\u0D36 \u0D38\u0D4D\u0D35\u0D2F\u0D02\u0D2D\u0D30\u0D23\u0D02 / \u0D2A\u0D1E\u0D4D\u0D1A\u0D3E\u0D2F\u0D24\u0D4D\u0D24\u0D4D",
        location: "\u0D2A\u0D1E\u0D4D\u0D1A\u0D3E\u0D2F\u0D24\u0D4D\u0D24\u0D4D \u0D31\u0D4B\u0D21\u0D4D, \u0D05\u0D34\u0D3F\u0D2F\u0D42\u0D7C \u0D1C\u0D02\u0D17\u0D4D\u0D37\u0D28\u0D4D, \u0D1A\u0D4B\u0D2E\u0D4D\u0D2A\u0D3E\u0D32, \u0D15\u0D4B\u0D34\u0D3F\u0D15\u0D4D\u0D15\u0D4B\u0D1F\u0D4D",
        hours: "\u0D30\u0D3E\u0D35\u0D3F\u0D32\u0D46 10:00 - \u0D35\u0D48\u0D15\u0D41\u0D28\u0D4D\u0D28\u0D47\u0D30\u0D02 5:00 (\u0D1E\u0D3E\u0D2F\u0D7C \u0D12\u0D34\u0D3F\u0D15\u0D46)",
        contactName: "\u0D36\u0D4D\u0D30\u0D40\u0D2E\u0D24\u0D3F \u0D31\u0D40\u0D28 \u0D35\u0D3F\u0D1C\u0D2F\u0D7B, \u0D35\u0D3F\u0D15\u0D38\u0D28 \u0D38\u0D4D\u0D31\u0D4D\u0D31\u0D3E\u0D7B\u0D21\u0D3F\u0D19\u0D4D \u0D15\u0D2E\u0D4D\u0D2E\u0D3F\u0D31\u0D4D\u0D31\u0D3F \u0D1A\u0D46\u0D2F\u0D7C\u0D2A\u0D47\u0D34\u0D4D\u0D38\u0D7A"
      },
      en: {
        title: "Azhiyur Grama Panchayat Headquarters Office",
        description: "Local administrative headquarters for Azhiyur Grama Panchayat (covering Azhiyur, Chombala, and Mukkali coastal areas). Handles civic registrations, beach management, sea erosion barrier coordination, and pension verification.",
        category: "Grama Panchayat Office",
        location: "Panchayat Road, Azhiyur Junction, Chombala PO, Kozhikode District",
        hours: "10:00 AM - 5:00 PM (Closed Sundays)",
        contactName: "Smt. Reena Vijayan, Standing Committee Chairperson"
      },
      hi: {
        title: "अझीयूर ग्राम पंचायत प्रशासनिक कार्यालय",
        description: "अझीयूर ग्राम पंचायत (अझीयूर, चोमबाला और मुक्काली तटीय क्षेत्रों) का स्थानीय प्रशासनिक मुख्यालय। नागरिक पंजीकरण, तटीय विकास और पेंशन सत्यापन सेवाएं।",
        category: "ग्राम पंचायत कार्यालय",
        location: "पंचायत रोड, अझीयूर जंक्शन, चोमबाला, कोझिकोड",
        hours: "सुबह 10:00 - शाम 5:00 (रविवार अवकाश)",
        contactName: "श्रीमती रीना विजयन, समिति अध्यक्ष"
      },
      te: {
        title: "అళీయూర్ గ్రామా పంచాయతీ పరిపాలనా కార్యాలయం",
        description: "అళీయూర్ గ్రామా పంచాయతీ స్థానిక పరిపాలనా కేంద్రం (అళీయూర్, చోంబాల, ముక్కాళి ప్రాంతాలు). జనన, మరణ ధృవీకరణ పత్రాలు మరియు ప్రజా సంక్షేమ పథకాల పర్యవేక్షణ.",
        category: "గ్రామ పంచాయతీ కార్యాలయం",
        location: "పంచాయతీ రోడ్, అళీయూర్ జంక్షన్, చోంబాల, కోజికోడ్",
...
const AZHIYUR_SUB_LOCALITIES = [
  { en: "Mukkali Town", ml: "മുക്കാലി ടൗൺ", hi: "मुक्काली टाउन", te: "ముక్కాళి టౌన్" },
  { en: "Azhiyur Chungam", ml: "അഴിയൂർ ചുങ്കം", hi: "अझीयूर चुंगम", te: "అళీయూర్ చుంగం" },
  { en: "Chombala", ml: "ചോമ്പാല", hi: "चोमबाला", te: "చోంబാല" },
  { en: "Koroth Road", ml: "കോറോത്ത് റോഡ്", hi: "कोरोथ रोड", te: "కోరోత్ రోഡ്" },
  { en: "Kunhippally", ml: "കുഞ്ഞിപ്പള്ളി", hi: "കുञ്जिप्पल्ली", te: "కుఞ్జిప్పల్లి" },
  { en: "Poozhithala", ml: "പൂഴിത്തല", hi: "पूषिथला", te: "పూళితല" },
  { en: "Avikkara", ml: "ആവിക്കര", hi: "आविक्करा", te: "ആവിక్కര" },
  { en: "Chirayil Peedika", ml: "ചിറയിൽ പീടിക", hi: "चिरायिल पीडिका", te: "చిరాయిൽ పീഡിక" },
  { en: "Ancham Peedika", ml: "അഞ്ചാം പീടിക", hi: "അंचाम पीडिका", te: "അంచాం പീഡിക" },
  { en: "Kottamala", ml: "കോട്ടമല", hi: "कोट्टमला", te: "കോట్టമല" },
  { en: "Manankara", ml: "മണങ്കര", hi: "मणंकरा", te: "మణంకర" },
  { en: "Panada", ml: "പനാട", hi: "पनाडा", te: "పనాడ" },
  { en: "Kallamala", ml: "കല്ല മല", hi: "कल्लामला", te: "കല്ലമല" },
  { en: "Kolarad", ml: "കൊളരാട്", hi: "कोलराड", te: "కొలరాడ్" },
  { en: "Theru", ml: "തെരു", hi: "थेरू", te: "తేరు" },
  { en: "Karappakunnu", ml: "കരാപ്പക്കുന്ന്", hi: "कराप्पकुन्नू", te: "കരാപ്പകുన్ను" },
...
const LOCALITIES_EN = {
  ...
  "Kozhikode": [
    "Azhiyur", "Mukkali Town", "Azhiyur Chungam", "Chombala", "Koroth Road",
    "Kunhippally", "Poozhithala", "Avikkara", "Chirayil Peedika", "Ancham Peedika",
    "Kottamala", "Manankara", "Panada", "Kallamala", "Kolarad", "Theru",
    "Karappakunnu", "Andicompany", "Koyilandy", "Vadakara", "Mukkam",
    "Ramanattukara", "Feroke", "Koduvally", "Payyoli", "Kunnamangalam"
  ],
...
const LOCALITIES_ML = {
  ...
  "Kozhikode": [
    "അഴിയൂർ", "മുക്കാലി ടൗൺ", "അഴിയൂർ ചുങ്കം", "ചോമ്പാല", "കോറോത്ത് റോഡ്",
    "കുഞ്ഞിപ്പള്ളി", "പൂഴിത്തല", "ആവിക്കര", "ചിറയിൽ പീടിക", "അഞ്ചാം പീടിക",
    "കോട്ടമല", "മണങ്കര", "പനാട", "കല്ല മല", "കൊളരാട്", "തെരു",
    "കരാപ്പക്കുന്ന്", "അണ്ടി കമ്പനി", "കൊയിലാണ്ടി", "വടകര", "മുക്കം",
    "രാമനാട്ടുകര", "ഫറോക്ക്", "കടുവള്ളി", "പയ്യോളി", "കുന്ദമംഗലം"
  ],
...
function generateRemainingServices() {
  ...
  // 1. Generate 5 services per category (25 total) for ALL 672 Kerala Panchayats
  KERALA_DISTRICTS_LIST.forEach((dist, dIdx) => {
    const panchayats = KERALA_PANCHAYATS_BY_DISTRICT[dist.en] || [];
    panchayats.forEach((pnc, pncIdx) => {
      if (pnc.en === "Azhiyur") return;
      const services = buildPanchayatServices("kerala", dist, pnc, dIdx * 100 + pncIdx);
      result.push(...services);
    });
  });

  // 2. Generate 5 services per category (25 total) for ALL 259 Karnataka Panchayats
  KARNATAKA_DISTRICTS_LIST.forEach((dist, dIdx) => {
    const panchayats = KARNATAKA_PANCHAYATS_BY_DISTRICT[dist.en] || [];
    panchayats.forEach((pnc, pncIdx) => {
      const services = buildPanchayatServices("karnataka", dist, pnc, dIdx * 100 + pncIdx);
      result.push(...services);
    });
  });

  // 3. Generate 5 services per category (25 total) for ALL 34 Andhra Pradesh Panchayats
  ANDHRAPRADESH_DISTRICTS_LIST.forEach((dist, dIdx) => {
    const panchayats = ANDHRAPRADESH_PANCHAYATS_BY_DISTRICT[dist.en] || [];
    panchayats.forEach((pnc, pncIdx) => {
      const services = buildPanchayatServices("andhra", dist, pnc, dIdx * 100 + pncIdx);
      result.push(...services);
    });
  });

  // 4. Generate 5 services per category (25 total) for Tamil Nadu Panchayats (top 20 per each of the 38 districts)
  TAMILNADU_DISTRICTS_LIST.forEach((dist, dIdx) => {
    const panchayats = (TAMILNADU_PANCHAYATS_BY_DISTRICT[dist.en] || []).slice(0, 20);
    panchayats.forEach((pnc, pncIdx) => {
      const services = buildPanchayatServices("tamilnadu", dist, pnc, dIdx * 100 + pncIdx);
      result.push(...services);
    });
  });
